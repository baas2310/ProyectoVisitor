                        ...
                        <div class="card-box">
                            ...
                            <form id="wizard-clickeable" role="form" method="post" action="../../../Controlador/ControlInternos.php?accion=crear" enctype='multipart/form-data'>
                                ...
                                <div class="row m-t-17">
                                    ...
                                    <select aria-required='true' class='form-control'required id="cbx_Carcel" name="cbx_Carcel"  >
                                        <option value="">Seleccionar Carcel</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cbx_Ubicacion" required id="cbx_Ubicacion"></select>
