                                ...
                                <div class="account-box">
                                    <div class="text-center account-logo-box">
                                        <h2 class="text-uppercase">
                                            <a href="index.php" class="text-success">
                                                <span><img src="assets/images/LogoMomentaneo.jpg" alt="" height="30"></span>
                                            </a>
                                        </h2>
                                    ...
                                    <div class="account-content">
                                        <div class="text-center m-b-20">
                                            ...
                                            <p class="text-muted font-13 m-t-10"> Vuelve a iniciar sesión<a href="index.php" class="text-primary m-r-5"><b> aquí</b></a></p>
                                        </div>
