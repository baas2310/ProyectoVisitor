        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="text-center text-custom">LISTA DE FUNCIONARIOS</h4>
                            ...
                            <div class="panel-body">
                                <table class="table table-hover m-0 table-colored-bordered table-bordered-inverse tickets-list table-actions-bar dt-responsive nowrap" cellspacing="0" width="100%" id="datatable">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 text-xs-center">
                                                <div class="form-group">
                                                    <button onclick="location.href='RegistrarFuncionarios.php'" id="Registrar" class="btn btn-success m-b-20"><i class="fa fa-plus m-r-5"></i>Añadir Registro</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php echo ControlFuncionarios::AdminTableFuncionario($_SESSION["user"]=$_SESSION["DataUser"]["IdFuncionario"]); ?>
